...
from gamePackage.AutoPaddleClass import AutoPaddle
from gamePackage.BallClass import Ball
from gamePackage.PaddleClass import Paddle
from gamePackage.ScoreboardClass import Scoreboard
from main import window_width, window_height, display_surf, WHITE


class Game():
    def __init__(self, line_thickness=5, speed=5):
